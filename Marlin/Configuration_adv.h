...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  110, 20 }, { 40,  120 }, { 185, 120 } }

  // Define positions names for probing points.
  #define TRAMMING_POINT_NAME_1 "Front"
  #define TRAMMING_POINT_NAME_2 "Left"
  #define TRAMMING_POINT_NAME_3 "Right"
...
#define BABYSTEPPING
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.
    ...
    #define DOUBLECLICK_MAX_INTERVAL 1550   // Maximum interval between clicks, in milliseconds.
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH       28  // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT       16  // (mm) Unload initial retract length.
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       620        // (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_CURRENT_HOME  465  // (mA) RMS current for sensorless homing
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       620
    #define Y_CURRENT_HOME  465
    #define Y_MICROSTEPS     16
